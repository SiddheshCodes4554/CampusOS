    ...
    <div className="fade-in-entry flex flex-col gap-6">
      <div className="flex flex-col gap-1.5">
        ...
        <p className="text-[var(--text-secondary)] text-sm">
          Prepare for technical coding interviews, quantitative tests, and behavioral assessments.
        </p>
      </div>
      ...
      <GlassCard className="p-8 flex flex-col items-center justify-center text-center gap-4">
        ...
        <div className="flex flex-col gap-1">
          <span className="text-sm font-semibold text-[var(--text-primary)]">Mock Interview Terminal</span>
          <span className="text-xs text-[var(--text-muted)] max-w-sm">
            AI-driven coding assessments, system architecture guides, and behavioral prompts will appear here.
          </span>
        </div>
      </GlassCard>
    </div>
