    ...
    <div className="fade-in-entry flex flex-col gap-6">
      <div className="flex flex-col gap-1.5">
        ...
        <p className="text-[var(--text-secondary)] text-sm">
          Generate production-ready projects and step-by-step guidance guides using AI.
        </p>
      </div>
      ...
      <GlassCard className="p-8 flex flex-col items-center justify-center text-center gap-4">
        ...
        <div className="flex flex-col gap-1">
          <span className="text-sm font-semibold text-[var(--text-primary)]">Interactive Project Guides</span>
          <span className="text-xs text-[var(--text-muted)] max-w-sm">
            Configure target tech stacks, database models, and architectural steps for your resume projects.
          </span>
        </div>
      </GlassCard>
    </div>
